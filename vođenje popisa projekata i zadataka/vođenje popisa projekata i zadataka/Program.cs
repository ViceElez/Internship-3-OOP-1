...
namespace vođenje_popisa_projekata_i_zadataka
{
    public class Program
    {
     ...
     new List<Task>
     {  
        new Task("Dizajn pocetne stranice", "Kreirati vizualno privlacnu pocetnu stranicu", "Zavrsen","Visok",
                 "Razvoj web stranice", new DateTime(2024, 2, 1), 120),
        new Task("Postavljanje hostinga", "Konfigurirati hosting za web stranicu", "Aktivan","Srednji",
                 "Razvoj web stranice", new DateTime(2024, 3, 15), 60),
        new Task("Razvoj stranice za kontakt", "Dodati obrazac za kontakt i podatke", "Na cekanju","Niski",
            ...
            projectTasksMapping.Add(
                ...
                new List<Task>
                {
        new Task("Izrada zicanih okvira", "Dizajniranje zicanih okvira aplikacije", "Zavrsen","Visok",
                 "Mobilna aplikacija", new DateTime(2024, 11, 23), 100),
        new Task("Razvoj Backend API-a", "Izgraditi backend za aplikaciju", "Aktivan","Visok",
                 "Mobilna aplikacija", new DateTime(2024, 5, 10), 200),
        new Task("Implementacija autentifikacije", "Dodati sustav autentifikacije korisnika", "Na cekanju","Srednji",
            ...
            projectTasksMapping.Add(
                ...
                new List<Task>
                {
        new Task("Prikupljanje sirovih podataka", "Prikupiti prodajne podatke sa svih odjela", "Zavrsen","Niski",
                 "Analiza podataka", new DateTime(2023, 12, 1), 50),
        new Task("Ciscenje podataka", "Pripremiti podatke za analizu", "Zavrsen","Visoki",
                 "Analiza podataka", new DateTime(2023, 12, 15), 70),
        new Task("Generiranje vizualnih izvještaja", "Kreirati vizualne prikaze podataka", "Aktivan","Srednji",
